...
\begin{align*}
    control(qArg, & && \quad id \ qArg_1, \dots, qArg_{n'} \texttt{;}) = \\  
    ...
    & \ \texttt{ctrl(1) @ } \texttt{negctrl(}n\texttt{) } &&\texttt{@ }id \ qArg, qArg_1, \dots, qArg_{n'}\texttt{;}\\
    ...
    control(qArg, & \ \texttt{ctrl(}n_1 \texttt{) @ } \texttt{negctrl(}n_2\texttt{) } &&\texttt{@ } id \ qArg_1, \dots, qArg_{n'} \texttt{;}) = \\
    & \ \texttt{ctrl(}n_1+1 \texttt{) @ } \texttt{negctrl(}n_2\texttt{) } &&\texttt{@ } id \ qArg, qArg_1, \dots, qArg_{n'}\texttt{;}
\end{align*}
