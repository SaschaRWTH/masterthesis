...
% Lastly, we give some basic information on the testing and continuous integration of the project. 
%\todo{General info on implementation with C\# and .NET}
...
% Necessary? Already comprehensive description of compiler
