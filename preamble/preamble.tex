...
% 		decimal, int, sbyte, virtual, string, public
...
\lstdefinestyle{ANTLR}{                 
    ...
    % rulecolor=\color{brown}\bfseries         % Highlight grammar rules in bold brown
}
