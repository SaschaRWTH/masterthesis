...
\lstdefinestyle{QCM}{
    ...
    commentstyle={\color{commentgreen}},%                  gray italics for comments
    ...
    keywordstyle={\color{cyan}},%                         and format them in black
}
...
\lstdefinestyle{CSharp}{                 
    ...
    moredelim=[s][\color{orange}]{'}{'},     % Style for character literals (e.g., 'a')
}
